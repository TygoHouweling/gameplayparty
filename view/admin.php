		      ...
		      <div class="small-screen navbar-display">
                ...
                <li class="dropdown">
				 ...
				 <li class="dropdown">
                    ...
                    <ul class="collapse list-unstyled menu" id="pageSubmenu3">
                        <li >
                            <a href="" data-toggle="modal" data-target="#myModal1">Visit chart</a>
                        </li>
                    </ul>
                </li>
				  <li class="dropdown">
				...
				<li class="dropdown">
                    ...
                    <ul class="collapse list-unstyled menu" id="pageSubmenu5">
                        <li>
                            <a data-toggle="modal" data-target="#myModal5">New tournament</a>
                        </li>
                        <li>
                            <a data-toggle="modal" data-target="#myModal4">New admin</a>
                        </li>
                    </ul>
                </li>
			   ...
			   <li class="dropdown">
			     ...
			     <li class="dropdown">
                    ...
                    <ul class="collapse list-unstyled menu" id="pageSubmenu7">
                        <li>
                            <a onclick="test(this.id)" id="1" data-toggle="modal" data-target="#manager1">Edit "About us"</a>
                        </li>
                        <li>
                            <a onclick="test(this.id)" id="2" data-toggle="modal" data-target="#manager2">Edit "Laatste projecte"</a>
                        </li>
                        <li>
                            <a onclick="test(this.id)" id="3" data-toggle="modal" data-target="#manager3">Edit "About us"</a>
                        </li>
                    </ul>
                </li>
               ...
               <li class="">
				 ...
				 <li  class="">
                    <a data-toggle="modal" data-target="#myModal7"><i class="material-icons">library_books</i><span>Calender</span></a>
                </li>
