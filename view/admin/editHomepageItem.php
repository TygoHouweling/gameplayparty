...
<body>
    <div class="m-4">
        ...
        ?>
            <form style="display: flex; justify-content:center; flex-direction:column" method="post" action="?cat=admin&op=editHomepageItem&item=<?= $row['area_id'] ?>" enctype="multipart/form-data">
